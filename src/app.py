...
activities = {
    ...
    "Soccer Team": {
        ...
        "max_participants": 22,
        "participants": ["lia@mergington.edu", "noah@mergington.edu"]
    },
    "Swim Club": {
        "description": "Improve swimming technique and endurance while preparing for meets",
    ...
    "Drama Society": {
        "description": "Work on acting, stage production, and theatrical performances",
    ...
    "Science Olympiad": {
        "description": "Study science topics and prepare for academic competitions",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
